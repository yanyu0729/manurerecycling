...
```{r}
head(crop_manure_map)

sourcedata4 <- crop_manure_map %>%
  dplyr::select(GEOID, mansur1gg, mansur2gg, mansur3gg, mansur4gg, m1gg, m2gg, c1gg, total_cafo, potential_recover,exisN, ext, ext80,applied_manure_re )

sourcedata4 <- st_drop_geometry(sourcedata4)
sourcedata4 <- merge(counties, sourcedata4, by = "GEOID")

sourcedata4 <- st_drop_geometry(sourcedata4)

write_xlsx(sourcedata4, "~/Desktop/revised manure sur/submission/source data 4/sourcedata4.xlsx")
